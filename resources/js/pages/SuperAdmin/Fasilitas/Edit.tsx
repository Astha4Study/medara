...
export default function FasilitasEditSuperAdmin() {
    const { fasilitas } = usePage<PageProps>().props;

    const { data, setData, processing, put, errors } = useForm({
        nama: fasilitas.nama, // preload nilai
    });
    ...
    const handleSubmit: FormEventHandler = (e) => {
        e.preventDefault();
        put(`/super-admin/fasilitas-klinik/${fasilitas.id}`, {
            onSuccess: () => {
            ...
            <div className="p-6">
                <div className="mb-6">
                    ...
                    <p className="mt-1 text-sm text-gray-500">
                        Perbarui nama fasilitas berikut
                    </p>
                </div>

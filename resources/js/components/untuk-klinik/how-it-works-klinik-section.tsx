...
const steps = [
    {
        title: 'Daftarkan Klinik Anda',
        description:
            'Isi formulir pendaftaran dan lengkapi data klinik untuk bergabung sebagai mitra Kinara.',
        icon: Building2,
    ...
    },
    {
        ...
        description:
            'Tim Kinara akan memverifikasi data klinik Anda dan mengaktifkan akun mitra.',
        icon: ClipboardCheck,
        color: 'bg-teal-500',
    },
    {
        ...
        description:
            'Tambahkan jenis layanan, dokter, serta jadwal praktik agar pasien bisa booking dengan mudah.',
        icon: Settings,
        color: 'bg-cyan-500',
    },
    {
        title: 'Mulai Terima Pasien',
        description:
            'Klinik Anda siap menerima reservasi online, mengelola antrean, dan meningkatkan kepuasan pasien.',
        icon: Users,
        color: 'bg-green-700',
    },
];
            ...
            <div className="mx-auto w-full max-w-7xl">
                ...
                <div className="mb-10 text-center">
                    ...
                    <h2 className="mt-3 text-3xl font-semibold text-gray-900 md:text-4xl">
                        Bagaimana Klinik Bergabung dengan Kinara?
                    </h2>
                    <p className="mx-auto mt-4 max-w-3xl text-base text-gray-600">
                        Kinara mempermudah klinik untuk bergabung sebagai mitra,
                        mengelola layanan, dan meningkatkan operasional dengan
              ...
              <img
                src="/images/how-it-works-klinik.png"
                alt="How Kinara Works for Klinik"
...
export default HowItWorksKlinikSection;
